...
module.exports = (api, options) => {
  api.registerCommand('init', {
    ...
    prompt([{
      ...
      name: 'line',
      choices: ['vue-h5-app', 'vue-pc-app', 'vue-pc-style2-app'],
  ...
  function pullVuePcStyle2Tpl() {
    ...
    // console.log(process.cwd())
    download('direct:https://github.com/tffe-team/vue-pc2-app.git', './', { clone: true }, function (err) {
      if(err) {
        //todo 非空目录判断
        spinner.fail(err)
      } else {
