...
async function build(args, api, options) {
    ...
    const internationaBuild = require('./internationaBuild')
    ...
    return new Promise((resolve, reject) => {
        webpack(webpackConfig, (err, stats) => {
            ...
            if (!args.silent) {
               ...
               // const domainList = options.domainList && options.domainList.length ? options.domainList.filter(({item}) => {return item.isBuild === ture }) : []
                let domainList = []
                ...
                log('    config\n')
                log(createJsonFile(configPathInfo, formatStatsInfo.configInfo))
                log(createJsonFile(staticPathInfo, formatStatsInfo.staticPathInfo))
                domainList.length && internationaBuild(targetDirShort, options, domainList)
